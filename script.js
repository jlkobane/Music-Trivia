...
const answerInput8El = document.querySelector('#User-Answer8');
...
const answerInput18El = document.querySelector('#User-Answer18');
...
const answerInput28El = document.querySelector('#User-Answer28');
...
const allCounterDisplays = document.querySelector('.All-Counter-Displays')
